...
子命令:
  ...
  setting get <键>       读取应用设置（proxy / watch_enabled / github_token / auto_start_apps）
                ...
                match sub.as_str() {
                    ...
                    "set" => {
                        match key.as_str() {
                            ...
                            "auto_start_apps" => {
                                settings.auto_start_apps = value
                                    .split(',')
                            ...
                            other => {
                                return Err(anyhow::anyhow!(
                                    "未知设置键: {other}（可用: proxy / watch_enabled / github_token / auto_start_apps）"
                                ))
                            }
                        }
